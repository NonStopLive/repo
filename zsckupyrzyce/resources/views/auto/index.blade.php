...
<div class="panel">
    <script type="text/javascript"> 
        var wynik;
            ...
            Od: <input type="text" class="form-control" placeholder="Podaj odległość" id="x" name="from" data-id="1"/>
            Do: <input type="text" class="form-control" placeholder="Podaj odległość" id="y" name="to" data-id="1"/>
